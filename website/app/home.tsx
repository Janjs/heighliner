...
export type SourceFile = { name: string; size: number; type: string };
...
export type RouteStep = Pick<FlowData, "label" | "detail" | "kind"> & {
...
export function SystemMark({ name, logo }: { name: string; logo?: string }) {
...
export function normalizeRouteSystems(
